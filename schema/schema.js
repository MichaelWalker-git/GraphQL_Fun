...
const {
	GraphQLObjectType, GraphQLInt, GraphQLString, GraphQLSchema, GraphQLList, GraphQLNonNull
} = graphql;
...
/**
 * DRY process for preventing repeating query requests for company details.
 */
	...
	fields: {
		...
		deleteUser: {
			...
			resolve(parentValue, {userId}) {
				return axios.delete(`http://localhost:3000/users/${userId}`).then((res) => res.data);
			}
		}
	}
});
